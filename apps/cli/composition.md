...
The dsh-base bundle patch every profile applies first; GUI profiles add dsh-gui-app before their product transport, while headless and user layers patch the same base.
