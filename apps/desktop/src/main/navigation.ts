...
import { DESKTOP_REPOSITORY } from '../shared/release-policy.ts'

const communityRepository = new URL(DESKTOP_REPOSITORY)
  ...
  try {
    ...
    return url.hostname === 'github.com'
      && (url.pathname === '/deepseek-ai/deepseek-harness'
        ...
        || url.pathname === communityRepository.pathname
        || url.pathname.startsWith(`${communityRepository.pathname}/`))
  } catch {
    return false
  }
}
