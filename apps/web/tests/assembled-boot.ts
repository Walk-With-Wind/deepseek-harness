...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  ...
  { id: '@deepseek-ai/dsh-session-log-saver-web', bundlePath: 'packages/session-query/session-log-saver-web/lib/client.js', url: '/plugins/session-log-saver-web.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-connection'] },
