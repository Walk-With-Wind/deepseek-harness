...
| [host-lifecycle.md](host-lifecycle.md) | 与进程无关的 profile 启动、规范化 home 身份、跨产品 `HostLease`、ready 所有权与 quiescent 释放 |
| [client-modules.md](client-modules.md) | GUI 模块注册表：`dsh.client` 声明、图与资源清单组合，以及产品专属的 Web／Desktop adapter |
