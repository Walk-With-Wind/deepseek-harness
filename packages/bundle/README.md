...
| [`gui-app/`](gui-app/README.md) | Shared GUI Host capabilities and client roster over base | — (patch only) |
| [`web-app/`](web-app/README.md) | Browser transport and runtime glue over gui-app | mounts Web rows |
