...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  clientCarrier: 'client-side interface-typed boot service — packages/client/connection/README.md owns the API',
  guiPlatform: 'client-side interface-typed boot service — packages/client/web/README.md owns the API',
  hostModuleBaseUrl: 'not a service: closed-host package-resolution anchor installed by app-boot — packages/boot/app-boot/README.md owns the boot contract',
