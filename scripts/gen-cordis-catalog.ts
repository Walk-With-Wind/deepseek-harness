...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  hostModuleBaseUrl: 'not a service: launcher-provided optional module-resolution anchor — docs/subsystems/client-modules.md owns the resolution policy',
  ...
  clientCarrier: 'client-side transport value provided by the product bootstrap — packages/client/connection/README.md owns the API',
  ...
  guiPlatform: 'client-side product-capability value provided by the GUI bootstrap — packages/client/web/README.md owns the API',
  ...
  sessionLogSaver: 'client-side platform save capability — packages/session-query/session-log-export/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ImageAttachmentPreview: 'attachment.md',
  PreparedImageAttachmentBatch: 'attachment.md',
  SaveImageAttachment: 'attachment.md',
  StreamImageAttachment: 'attachment.md',
  ...
  ClientResourceManifest: 'client-modules.md',
