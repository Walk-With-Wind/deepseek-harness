...
const GENERATED_DEPENDENCY_FACES = [
  {
    workspace: 'packages/context/file-reference',
    artifact: 'packages/context/file-reference/lib/typert.host.js',
    dependency: 'zod',
  },
  {
    workspace: 'packages/context/session-reference',
    artifact: 'packages/context/session-reference/lib/typert.host.js',
    dependency: 'zod',
  },
  {
