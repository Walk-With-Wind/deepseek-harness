...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/gui-app': { kind: 'indirect', reason: 'The bundle is a patch-list carrier; each inserted GUI row owns its model-facing behavior.' },
  ...
  'packages/session-query/session-log-saver-web': { kind: 'none', reason: 'Browser download initiation stays on the human control plane and never enters model context.' },
